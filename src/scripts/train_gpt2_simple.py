"""
Simple GPT-2 Small Matryoshka Transcoder training with reliable dataset.

This version uses C4 dataset which is more reliable than OpenWebText.
"""
...
def main():
    """Train GPT-2 Small Matryoshka Transcoder with C4 dataset."""
    
    print("=" * 70)
    print("GPT-2 Small Matryoshka Transcoder Training (Simple Version)")
    print("=" * 70)
    ...
    # Training settings
    cfg["num_tokens"] = int(1e7)  # 10M tokens for quick training
    cfg["model_batch_size"] = 8   # Smaller batch for stability
    cfg["batch_size"] = 1024
    cfg["seq_len"] = 64
    cfg["lr"] = 3e-4
    ...
    # W&B settings
    cfg["wandb_project"] = "gpt2-matryoshka-transcoder-simple"
    cfg["checkpoint_freq"] = 500  # Save every 500 steps
    cfg["perf_log_freq"] = 250    # Log performance every 250 steps
