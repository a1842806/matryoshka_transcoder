"""
Train Gemma-2-2B Matryoshka Transcoder on Layer 12 with Cosine Decay.

This script trains a Matryoshka transcoder with cosine annealing decay scheduling.
Designed to run on GPU 1 for comparison with standard training.

Usage:
    CUDA_VISIBLE_DEVICES=1 python train_gemma_layer12_transcoder_decay.py
"""
...
def main():
    ...
    print("=" * 80)
    print("Gemma-2-2B Matryoshka Transcoder Training - Layer 12 (COSINE DECAY)")
    print("=" * 80)
    ...
    # Learning Rate Scheduling - COSINE DECAY ONLY
    cfg["scheduler_type"] = "decay_only"
    ...
    cfg["wandb_project"] = "gemma-2-2b-layer12-transcoder-decay"
    ...
    # Training
    print("\n" + "=" * 80)
    print("🚀 Starting training with COSINE DECAY scheduling...")
    print("=" * 80)
    print("Learning Rate Schedule:")
    print(f"  - Cosine annealing from {cfg['lr']:.1e} to {cfg['min_lr']:.1e}")
    print(f"  - Full cosine cycle over {cfg['num_tokens'] // cfg['batch_size']:,} steps")
    print("")
